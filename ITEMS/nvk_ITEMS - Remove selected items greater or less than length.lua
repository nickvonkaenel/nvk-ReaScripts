...
SimpleDraw = function()
    local rv
    rv, less, greater = ImGui.DragFloatRange2(ctx, 'Length', less, greater, nil, 0, 300, '%.1f seconds',
        '%.1f seconds', ImGui.SliderFlags_Logarithmic | ImGui.SliderFlags_NoRoundToFormat)
